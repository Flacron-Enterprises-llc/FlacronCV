...
const ALLOWED: Record<string, string> = {
  ...
  'contact.address': 'postal address — must remain deliverable as written',
  'contact.phone': 'telephone number — same digits in every locale',
  'contact.email_placeholder': 'example address',
