...
export const ATS_CV_CHECKER = {
  ...
  subtitle:
    'Paste a job description and see which keywords your CV matches and which it misses. A signed-in feature, one Engine credit per check.',
  hero_title: 'Check Your CV Against a Job Posting',
  hero_desc:
    'Paste the posting you are applying to, and get a comparison of its wording against your CV — which terms you already use, which you do not, and what you might add. You will need an account and a CV built here; each check uses one Engine credit.',
  ...
  how_desc:
    'Create an account, build or import a CV, then open it and paste the job description into the ATS check. Each check uses one Engine credit, and every plan including Free comes with credits to start.',
