...
describe('FlacronCV - Create Cover Letter Automation', () => {
 ...
 it('TC: 04: Enter Title and company name and leave job title and Validate AI genarted button error',{ retries: 1 }, () => {
 ...
 it('TC: 05: Enter Title and company name and job title and Validate AI genarted button error',{ retries: 1 }, () => {
...
it('TC: 06: Enter Values in all fields with AI generated job descrption and click AI Generate button for Job Description',{ retries: 1 }, () => {
    ...
    it('TC: 07: Enter Values in all fields and leave AI generated Job description click AI Generate button  and validate data on edit page,preview  window',{ retries: 1 }, () => {
    ...
    it('TC: 08: Validate Create Blank button with only providing title',{ retries: 1 }, () => {
    ...
    cy.wait(300)
     ...
     it('TC: 09: Validate Create Blank button with providing title, company name and title',{ retries: 1 }, () => {
